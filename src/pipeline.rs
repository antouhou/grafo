...
use crate::vertex::{CustomVertex, TexturedVertex, TransformInstance};
...
pub fn create_pipeline(
    ...
    let render_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        ...
        vertex: wgpu::VertexState {
            ...
            buffers: &[CustomVertex::desc(), TransformInstance::desc()],
        },
...
pub fn render_buffer_range_to_texture(
    ...
    instance_index: u32,         // which transform instance to use
    ...
    // 3. Use the specific instance index for the transform
    let index_start = index_range.0 as u32;
    let index_end = (index_range.0 + index_range.1) as u32;

    render_pass.draw_indexed(index_start..index_end, 0, instance_index..(instance_index + 1));
}
