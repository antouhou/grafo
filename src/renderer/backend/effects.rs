...
impl WgpuBackend {
    pub(in crate::renderer) fn ensure_composite_pipeline(&mut self) -> &CompositePipelineResources {
    ...
    pub(in crate::renderer) fn ensure_backdrop_pipelines(&mut self) {
    ...
    pub(in crate::renderer) fn ensure_effect_sampler(&mut self) {
