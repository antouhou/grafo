...
pub(in crate::renderer) struct BgraReadbackResources {
    pub(in crate::renderer) texture: Texture,
    view: TextureView,
    mapping: ReadbackMapping,
    pub(in crate::renderer) buffer: Buffer,
}
...
pub(in crate::renderer) struct ArgbReadbackTarget {
    pub(in crate::renderer) texture: Texture,
    view: TextureView,
    mapping: ReadbackMapping,
    pub(in crate::renderer) input_buffer: Buffer,
    pub(in crate::renderer) output_buffer: Buffer,
    pub(in crate::renderer) readback_buffer: Buffer,
    pub(in crate::renderer) params_buffer: Buffer,
...
pub(in crate::renderer) struct ArgbReadbackResources {
    pipeline: ComputePipeline,
    bind_group_layout: BindGroupLayout,
    pub(in crate::renderer) target: ArgbReadbackTarget,
}
...
impl WgpuBackend {
    ...
    pub(in crate::renderer) fn render_to_buffer(
        &mut self,
        commands: &RenderPlan,
        buffer: &mut Vec<u8>,
    ) -> Result<(), ReadbackError> {
    ...
    pub(in crate::renderer) fn render_to_argb32(
        &mut self,
        commands: &RenderPlan,
        out_pixels: &mut [u32],
    ) -> Result<(), ReadbackError> {
