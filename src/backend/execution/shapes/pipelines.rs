...
use crate::commands::ShapeDrawMaterial;
...
pub(in crate::backend) struct TextureMaterialPipelines {
    pub(in crate::backend) solid_layout: BindGroupLayout,
    pub(in crate::backend) gradient_layout: BindGroupLayout,
    pub(in crate::backend) solid_keep: RenderPipeline,
    pub(in crate::backend) gradient_keep: RenderPipeline,
    pub(in crate::backend) solid_increment: RenderPipeline,
    pub(in crate::backend) gradient_increment: RenderPipeline,
}
...
impl ShapePipelines {
    pub(in crate::backend) fn material_pipeline(
        &self,
