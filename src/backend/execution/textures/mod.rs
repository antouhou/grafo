...
impl IntermediateTextureResources {
    ...
    pub(in crate::backend::execution) fn resolve_id(
        &self,
    ...
    pub(in crate::backend::execution) fn insert_planned(
        &mut self,
    ...
    pub(in crate::backend::execution) fn reserve_planned(
        &mut self,
        texture: IntermediateTextureId,
    ) {
    ...
    pub(in crate::backend::execution) fn finish_plan(&mut self) {
        self.planned.clear();
        self.masks.clear();
