...
impl WgpuBackend {
    pub(in crate::wgpu_backend) fn ensure_composite_pipeline(
        &mut self,
    ...
    pub(in crate::wgpu_backend) fn ensure_backdrop_pipelines(&mut self) {
    ...
    pub(in crate::wgpu_backend) fn ensure_effect_sampler(&mut self) {
