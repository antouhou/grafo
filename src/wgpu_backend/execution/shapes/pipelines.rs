...
pub(in crate::wgpu_backend) struct TextureMaterialPipelines {
    ...
    pub(in crate::wgpu_backend) solid_keep: RenderPipeline,
    pub(in crate::wgpu_backend) gradient_keep: RenderPipeline,
    pub(in crate::wgpu_backend) solid_increment: RenderPipeline,
    pub(in crate::wgpu_backend) gradient_increment: RenderPipeline,
}
...
impl ShapePipelines {
    pub(in crate::wgpu_backend) fn material_pipeline(
        &self,
