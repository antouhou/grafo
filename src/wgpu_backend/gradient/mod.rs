...
use crate::wgpu_backend::execution::shapes::TextureSamplingUniform;
use lru::LruCache;
...
impl GradientCache {
    ...
    pub(super) fn get_or_create_ramp(&mut self, gradient_data: &GradientData) -> GradientRamp {
        ...
        let baked_ramp = ramp_source.bake();
